...
class MinimalActionServer(Node):
    ...
    async def execute_callback(self, goal_handle):
        ...
        for i in range(1, goal_handle.request.order):
            ...
            self.get_logger().info('SERVER 6 : Publishing feedback: {0}'.format(feedback_msg.sequence))
        ...
        self.get_logger().info('SERVER 6 : Returning result: {0}'.format(result.sequence))
