...
class MinimalActionServer(Node):
    ...
    async def execute_callback(self, goal_handle):
        ...
        for i in range(1, 5):
            ...
            self.get_logger().info('SERVER 1 : Publishing feedback: {0}'.format(feedback_msg.time_passed))
        ...
        result.transition = 't1'

        self.get_logger().info('SERVER 1 : Returning result: {0}'.format(result.transition))
